  ...
  return (
    <div className="w-full lg:w-[290px] h-[147px] bg-custom-gray8 flex flex-row justify-between rounded-3xl p-4 gap-3">
      ...
      <div className="w-[113px] h-[115px] flex flex-col justify-between">
        ...
        <div>
          <Link href={'./gameSpace'} className="w-[113px] h-[34px] bg-[#8621FF] flex justify-center items-center rounded-3xl border px-6 py-2 gap-2.5 font-Coiny-Regular font-normal text-white text-sm/[17.5px]">
            Join
          </Link>
        </div>
      </div>
